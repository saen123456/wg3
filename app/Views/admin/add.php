  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?php echo base_url('/dashboard'); ?>" class="brand-link">
        <img src=" <?php echo base_url('/dist2/img/AdminLTELogo.png'); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="<?php base_url('' . $this->session->get("Picture") . ''); ?>" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
