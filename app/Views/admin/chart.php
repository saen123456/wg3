            ...
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-outline-light" onclick="window.location.href = '<?= site_url('/AdminController/delete_indatabase') ?>';">ยืนยัน</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
    ...
    <script>
        $(function() {
            ...
            var donutData = {
                ...
                datasets: [{
                    data: [<?php echo $normal ?>, <?php echo $google ?>, <?php echo $facebook ?>],
                    backgroundColor: ['#33FFBE', 'red', 'blue'],
                }]
            }
            var donutOptions = {
